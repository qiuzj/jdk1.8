...
class Bits {                            // package-private
    ...
    static void putIntB(ByteBuffer bb, int bi, int x) {
        bb._put(bi    , int3(x)); // 高1字节
        bb._put(bi + 1, int2(x)); // 高2字节
        bb._put(bi + 2, int1(x)); // 低2字节
        bb._put(bi + 3, int0(x)); // 低1字节
    }
