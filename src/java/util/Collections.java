...
public class Collections {
    ...
    /**
     * 集合的同步版本，对传入的集合，各个方法进行synchronized操作
     * <p>
     * @serial include
     */
    ...
    /**
     * 列表的同步版本，对传入的列表集合，各个方法进行synchronized操作
     * <p>
     * @serial include
     */
    ...
    private static class SynchronizedMap<K,V>
        ...
        private final Map<K,V> m;     // Backing Map. 需要实现同步操作的Map对象
        final Object      mutex;        // Object on which to synchronize. 互斥锁
