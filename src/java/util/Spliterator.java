 ...
 * 从最早Java提供顺序遍历迭代器Iterator时，那个时候还是单核时代，但现在多核时代下，顺序遍历已经不能满足需求了...
 * 如何把多个任务分配到不同核上并行执行，才是能最大发挥多核的能力，所以Spliterator应运而生啦
 * 
 * 接口的设计思想，应该要提到的是Java7的Fork/Join(分支/合并)框架，
...
public interface Spliterator<T> {
    ...
    /**
     * 顺序处理下一个元素，如果元素存在则返回true，否则返回false
     * <p>
    ...
    /**
     * 遍历当前Iterator所有元素，对每个元素执行相应操作（action）
     * <p>
    ...
    /**
     * 把当前元素划分一部分出去创建一个新的Spliterator作为返回，
